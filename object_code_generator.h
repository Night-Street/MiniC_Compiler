...
#ifndef MINI_C_OBJECT_CODE_GENERATOR_H
#define MINI_C_OBJECT_CODE_GENERATOR_H
...
namespace object_code_generator {
    ...
    void firstPass() {
        ...
        while (1) {
            ...
            for (auto s: translateFunction(functionMap[curFunctionName], curInstr))
                functionMap[curFunctionName]->objectCodeList.push_back(s);
...
#endif //MINI_C_OBJECT_CODE_GENERATOR_H
